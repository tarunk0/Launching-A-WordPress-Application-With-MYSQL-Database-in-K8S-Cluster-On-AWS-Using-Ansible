...
In this article you will find that how we can launch a wordpress application connected with MySql database inside kubernetes Cluster on AWS and automation using Ansible.
...
![Running Main Playbook](https://github.com/tarunk0/automations-using-ansible/Launching-A-WordPress-Application-With-MYSQL-Database-in-K8S-Cluster-On-AWS-Using-Ansible/blob/main/Images/Running%20Main%20Playbook.gif?raw=true)
...
![WordPress Mysql](https://github.com/tarunk0/automations-using-ansible/Launching-A-WordPress-Application-With-MYSQL-Database-in-K8S-Cluster-On-AWS-Using-Ansible/blob/main/Images/Wordpress-Mysql.gif)
